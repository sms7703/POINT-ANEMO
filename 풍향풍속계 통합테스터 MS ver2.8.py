...
class AnemometerTesterApp:
    def __init__(self, master):
        self.master = master
        self.master.title("풍향풍속계 통합 테스터 민쑤 VER 2.8 ")
        ...
        self.patch_note_text = (
            "=== 패치노트 ===\n"
            "최종버전:25-11-28 ver 2.8 \n\n"
            "1)2.8 703 방향 스케일 범위 못찾음 32767/ 360적용중.\n"
    ...
    def open_patch_note(self):
        ...
        self.patch_win.geometry("320x220")
        ...
        text_widget = tk.Text(self.patch_win, height=10, width=40, wrap="word")
